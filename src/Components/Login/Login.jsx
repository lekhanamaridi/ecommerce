                ...
                <div class="text-2xl font-normal mb-4 text-center text-green-600">Log in to your account</div>
                    <form class="flex flex-col gap-3">
                        <div class="block relative"> 
                            ...
                            <input type="text" id="email" class="rounded border border-green-300 text-sm  font-normal leading-[18px] text-green-600 appearance-none block h-15 w-[400px] m-0 p-[11px] focus:ring-2 ring-offset-2  ring-green-300 outline-0"></input>
                        </div>
                        <div class="block relative"> 
                        ...
                        <button type="submit" class="bg-green mt-5 w-max m-auto px-10 py-4 rounded text-white text-xl font-bold">Submit</button>
