...
function ViewPage() {
    ...
    useEffect(()=>{
        ...
        fetch( `${process.env.REACT_APP_SERVER}/${category}`,
            {
                method:"POST",
                ...
                products.map((top)=>(
                    ...
                    <div class="flex flex-wrap p-1 m-1.5 ">
                        ...
                        <div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <img class="p-8 rounded-[40px] w-72 h-72 hover:scale-110 transition-all" src={top.images} alt="product" />
                            ...
                            <div class="px-5 pb-5">
                                ...
                                <div class="flex items-center justify-between">
                                    <span class="text-3xl font-bold text-gray-900 dark:text-white flex"> &#8377; {top.price}</span>
